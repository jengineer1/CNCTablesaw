...
button_1 = Button(
    calframe, text="1", padx=xpadnums, pady=ypadbutton, command=lambda: button_click(1)
)
button_2 = Button(
    calframe, text="2", padx=xpadnums, pady=ypadbutton, command=lambda: button_click(2)
)
button_3 = Button(
    calframe, text="3", padx=xpadnums, pady=ypadbutton, command=lambda: button_click(3)
)
button_4 = Button(
    calframe, text="4", padx=xpadnums, pady=ypadbutton, command=lambda: button_click(4)
)
button_5 = Button(
    calframe, text="5", padx=xpadnums, pady=ypadbutton, command=lambda: button_click(5)
)
button_6 = Button(
    calframe, text="6", padx=xpadnums, pady=ypadbutton, command=lambda: button_click(6)
)
button_7 = Button(
    calframe, text="7", padx=xpadnums, pady=ypadbutton, command=lambda: button_click(7)
)
button_8 = Button(
    calframe, text="8", padx=xpadnums, pady=ypadbutton, command=lambda: button_click(8)
)
button_9 = Button(
    calframe, text="9", padx=xpadnums, pady=ypadbutton, command=lambda: button_click(9)
)
button_0 = Button(
    calframe, text="0", padx=xpadnums, pady=ypadbutton, command=lambda: button_click(0)
)
...
button_add = Button(
    calframe, text="+", padx=xpadsymbols, pady=ypadbutton, command=button_add
)
button_equal = Button(
    calframe, text="=", padx=30, pady=ypadbutton, command=button_equal
)
button_clear = Button(
    calframe, text="Clear", padx=20, pady=ypadbutton, command=button_clear
)
button_subtract = Button(
    calframe, text="-", padx=xpadsymbols, pady=ypadbutton, command=button_subtract
)
button_multiply = Button(
    calframe, text="*", padx=xpadsymbols, pady=ypadbutton, command=button_multiply
)
button_divide = Button(
    calframe, text="/", padx=xpadsymbols, pady=ypadbutton, command=button_divide
)

inch_to_mm = Button(
    calframe, text="Inch to mm", padx=xpadbutton, pady=ypadbutton, command=Inch_to_mm
)
mm_to_inch = Button(
    calframe, text="mm to Inch", padx=xpadbutton, pady=ypadbutton, command=mm_to_Inch
)

# Define Other Buttons

button_movefence = Button(
    fenceframe, text="Move Fence", padx=xpadbutton, pady=ypadbutton, command=move_fence
)
button_change_angle = Button(
    angleframe,
    text="Change Angle",
    padx=xpadbutton,
    pady=ypadbutton,
    command=change_angle,
)
button_moveblade = Button(
    heightframe, text="Move blade", padx=xpadbutton, pady=ypadbutton, command=move_blade
)


button_change_angle_45 = Button(
    angleframe, text="Go To 45", padx=xpadbutton, pady=ypadbutton, command=shortcut_a45
)
button_moveblade_0 = Button(
    heightframe, text="Go To 0", padx=xpadbutton, pady=ypadbutton, command=shortcut_h0
)
button_change_angle_0 = Button(
    angleframe, text="Go To 0", padx=xpadbutton, pady=ypadbutton, command=shortcut_a0
)
button_moveblade_1 = Button(
    heightframe, text="Go To 1.0", padx=xpadbutton, pady=ypadbutton, command=shortcut_h1
)
...
cal_to_height_but_reset = Button(
    heightframe,
    text="Grab number",
    padx=xpadbutton,
    pady=ypadbutton,
...
clear_fen_but = Button(
    fenceframe, text="Clear", padx=xpadbutton, pady=ypadbutton, command=clear_fen
)
clear_ang_but = Button(
    angleframe, text="Clear", padx=xpadbutton, pady=ypadbutton, command=clear_ang
)
clear_height_but = Button(
    heightframe, text="Clear", padx=xpadbutton, pady=ypadbutton, command=clear_height
)
